...
public class FirstTest {
    private AppiumDriver driver; // There are AppiumDrivers, and we announces a new one, called "driver" of the dataType Appium Driver
    ...
    public void setUp() throws Exception {
		...
		capabilities.setCapability("noReset",true); //отключает обрубание теста/не выключает аппиум "Do not stop app, do not clear app data, and do not uninstall apk"

        driver = new AndroidDriver(new URL("http://127.0.0.1:4723/wd/hub"), capabilities); // AppiumDriver variable "driver" has such arguments of the datatype AndroidDriver
        /*
